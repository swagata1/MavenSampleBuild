...
public class MavenTestResource {
	...
	static Logger logger = Logger.getLogger(MavenTestResource.class.getName());
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/MavenTest/resource"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/MavenTest/resource/greet?name={name}"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/MavenTest/resource/{path}/"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/MavenTest/resource/prop"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/MavenTest/resource/unprotected"
	 */
	...
	/*
	 * Path for method:
	 * "<server address>/mfp/api/adapters/MavenTest/resource/protected"
	 */
